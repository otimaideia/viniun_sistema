...
import { ArrowDown, Users, Phone, Calendar, UserCheck, Star } from "lucide-react";
...
const stageIcons = [Users, Phone, Calendar, UserCheck, Star];
                ...
                <div className="flex items-center justify-center py-1">
                  <div className="flex items-center gap-2 text-muted-foreground">
                    ...
                    <span className="text-xs">
                      {data[index + 1].conversaoAnterior.toFixed(0)}% converteram
                    </span>
                  </div>
                </div>
              )}
      ...
      <div className="mt-4 pt-4 border-t border-border">
        <div className="flex items-center justify-between text-sm">
          ...
          <span className="font-bold text-success">
            {data[data.length - 1]?.percentual.toFixed(1) || 0}%
          </span>
        </div>
      </div>
    </div>
